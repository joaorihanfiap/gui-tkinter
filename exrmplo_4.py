...
rotulo1 = Label(container, text="Nº 1", font="Arial 16", pady=5)
rotulo1.pack(side=LEFT)

caixa_texto1 = Entry(container, font=("Times New Roman", "16"), width=10)
caixa_texto1.pack(side=LEFT)

caixa_texto2 = Entry(container, font=("Times New Roman", "16"), width=10)
caixa_texto2.pack(side=RIGHT)


rotulo2 = Label(container, text="Nº 2", font="Arial 16", pady=5)
...
botao = Button(container3, text="Click Me!", padx=10, pady=5, bg="purple", fg="white")
